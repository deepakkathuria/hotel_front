...
export default function SearchRooms() {
  ...
  // ✅ Parse URL query parameters and pre-fill form
  useEffect(() => {
    ...
    const parsedCheckin = checkinParam ? dayjs(checkinParam, "DD/MM/YYYY").format("YYYY-MM-DD") : "";
    const parsedCheckout = checkoutParam ? dayjs(checkoutParam, "DD/MM/YYYY").format("YYYY-MM-DD") : "";
    ...
    if (parsedCheckin && parsedCheckout) {
      setForm((prev) => ({
        ...
        adults: roomsParam ? parseInt(roomsParam) * 2 : prev.adults, // assume 2 adults per room
      }));
    }
  }, [location.search]);
